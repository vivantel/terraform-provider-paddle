...
Status: implemented, sandbox-run pending (compiles and skips correctly
without `PADDLE_API_KEY`; not yet executed for real — no key available
this session) — 2026-08-10. Simulations API researched and **rejected**:
